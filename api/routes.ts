...
export function RegisterRoutes(app: express.Express) {
  ...
  app.post('/api/widget',
    function(request: any, response: any, next: any) {
      ...
      const promise = controller.CreateWidget.apply(controller, validatedArgs as any);
      promiseHandler(controller, promise, response, next);
    });
  app.put('/api/widget',
    function(request: any, response: any, next: any) {
      ...
      const promise = controller.UpdateWidget.apply(controller, validatedArgs as any);
      promiseHandler(controller, promise, response, next);
    });
  app.delete('/api/widget/:widgetId',
    function(request: any, response: any, next: any) {
      ...
      const promise = controller.DeleteWidget.apply(controller, validatedArgs as any);
      promiseHandler(controller, promise, response, next);
    });
